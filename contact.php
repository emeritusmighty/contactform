    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-4">
                    <p>Phone:
                        <strong>+2348105799668</strong>
                    </p>
                    <p>Email:
                        <strong><a href="mailto:emeritusmighty@gmail.com">info@mightytech.com</a></strong>
                    </p>
                    <p>Address:
                        <strong>Adeleke University road,
                            <br>Ede, Osun State, Nigeria</strong>
                    </p>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p>Copyright &copy; MightyTech 2022</p>
                </div>
            </div>
        </div>
    </footer>
